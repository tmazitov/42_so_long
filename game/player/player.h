...
int							setup_attack_anime(t_player *player,
								t_player_anime *player_anime);
int							setup_idle_anime(t_player *player,
								t_player_anime *player_anime);
int							setup_move_anime(t_player *player,
								t_player_anime *player_anime);
int							setup_die_anime(t_player *player,
								t_player_anime *player_anime);
...
void						add_task(t_player *player, t_action action,
								t_anime *anime, int target);
t_anime						*task_proccess(t_scene *scene, t_player *player);
int							is_able_to_proccess(t_scene *scene,
								t_player *player);
int							is_movement(t_action action);
int							is_attack(t_action action);
int							task_count(t_player_task *task);
int							handle_player_attack(t_player *player,
								t_scene *scene);
#endif // !PLAYER_H