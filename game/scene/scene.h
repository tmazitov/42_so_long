...
t_scene					*make_scene(void *mlx, t_map *map, int height,
							int width);
...
t_scene_obj				*make_scene_obj(t_obj_type t, void *image, int x,
							int y);
...
t_chest					*make_chest(void *mlx, unsigned int money, int x,
							int y);
